...
const selectGameStage = (state: UIMachineSnapshot) => state.context.currentGameState?.gameStage;

const getStageDisplayInfo = (stage: GameStage | undefined) => {
    if (!stage) return null;

    // Only show the indicator for transient or special phases.
    // "PLAYING" is the default state and doesn't need a persistent badge.
