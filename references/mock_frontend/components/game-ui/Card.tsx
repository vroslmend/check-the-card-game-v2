...
export function Card({ card, isSelected = false, onClick, canInteract = true, layoutId, size = "md" }: CardProps) {
  ...
  const suitColors = {
    hearts: "text-stone-600 dark:text-stone-400",
    diamonds: "text-stone-600 dark:text-stone-400",
